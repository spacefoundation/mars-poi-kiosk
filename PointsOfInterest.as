...
package  {
	...
	public class PointsOfInterest extends Sprite {
		...
		private function definePOI():void {
			...
			poi.x = -70;
			poi.y = -42.7;
			poi.photoURI = "assets/img";
			poi.photoCredit = "Image Credit: ";
			poi.photoSource = "";
			poi.description = "";
			poi.descriptionSource = "";
			points.push(poi);
			...
			poi.x = 9.2;
			poi.y = 64.9;
			poi.photoURI = "assets/img/moc2_msss_crater_100.jpg";
			poi.photoCredit = "Image Credit: NASA/JPL/Malin Space Science Systems";
			poi.photoSource = "http://mars.jpl.nasa.gov/mgs/msss/camera/images/4_27_00_wintercrater/";
			poi.description = "It is still winter in the northern hemisphere of Mars. On April 20, 2000, the Mars Orbiter Camera (MOC) onboard Mars Global Sureyor (MGS) captured this view of a chilly Lomonosov Crater. The rims of the crater appear white because they are covered with wintertime frost. A dark patch just right of center on the crater floor is a sand dune field. Both low-lying ground fogs (fuzzy, patchy areas around the lower perimeter of the crater) and higher cloud layers (fuzzy white arcs seen within the crater and towards the upper right) obscure much of the surface.";
			poi.descriptionSource = "http://mars.jpl.nasa.gov/mgs/msss/camera/images/4_27_00_wintercrater/";
			points.push(poi);
			...
			poi.x = 158.1;
			poi.y = -40.5;
			poi.photoURI = "assets/img/600154main_PIA14479.jpg";
			poi.photoCredit = "Image Credit: NASA/JPL-Caltech/Univ. of Arizona";
			poi.photoSource = "http://www.nasa.gov/multimedia/imagegallery/image_feature_2095.html";
			poi.description = "This image, which combines orbital imagery with 3-D modeling, shows flows that appear in spring and summer on a slope inside Mars' Newton Crater. Sequences of observations recording the seasonal changes at this site and a few others with similar flows might be evidence of salty liquid water active on Mars today. Evidence for that possible interpretation is presented in a report by McEwen et al. in the Aug. 5, 2011, edition of Science.";
			poi.descriptionSource = "http://www.nasa.gov/multimedia/imagegallery/image_feature_2095.html";
			points.push(poi);
			...
			poi.x = -16.7;
			poi.y = -2.7;
			poi.photoURI = "assets/img/PIA04592.jpg";
			poi.photoCredit = "Image Credit: NASA/JPL/Malin Space Science Systems";
			poi.photoSource = "http://photojournal.jpl.nasa.gov/catalog/pia04592";
			poi.description = "Some of the most important high resolution imaging results of the Mars Global Surveyor (MGS) Mars Orbiter Camera (MOC) experiment center on discoveries about the presence and nature of the sedimentary rock record on Mars. This old meteor impact crater in northwestern Schiaparelli Basin exhibits a spectacular view of layered, sedimentary rock. The 2.3 kilometer (1.4 miles) wide crater may have once been completely filled with sediment; the material was later eroded to its present form.";
			poi.descriptionSource = "http://photojournal.jpl.nasa.gov/catalog/pia04592";
			points.push(poi);
			...
			poi.x = -31.8;
			poi.y = 23.6;
			poi.photoURI = "assets/img/cassini_crater_floor.jpg";
			poi.photoCredit = "Image Credit: NASA/JPL-Caltech/Arizona State University";
			poi.photoSource = "http://en.wikipedia.org/wiki/File:Cassini_crater_floor.JPG";
			poi.description = "Cassini Crater was named in 1973 for Italian astronomer Giovanni Cassini (1625-1712). Pictured above is a crater on the floor of Cassini crater, as seen by the Mars Reconnaissance Orbiter's HiRISE. The HiRISE camera was built by Ball Aerospace and Technology orporation and is operated by the University of Arizona.";
			poi.descriptionSource = "http://www.google.com/mars/";
			poi.descriptionSource2 = "http://en.wikipedia.org/wiki/File:Cassini_crater_floor.JPG";
			points.push(poi);
			...
			poi.x = -35.8;
			poi.y = 13.4;
			poi.photoURI = "assets/img/PIA13410.png";
			poi.photoCredit = "Image Credit: NASA/JPL-Caltech/Arizona State University";
			poi.photoSource = "http://www.jpl.nasa.gov/spaceimages/details.php?id=PIA13410";
			poi.description = "Tikhonravov Crater is a large, old crater in Terra Sabaea. The crater is pockmarked by numerous younger craters and other features. This VIS image shows a channel within Tikhonravov Crater.";
			poi.descriptionSource = "http://www.jpl.nasa.gov/spaceimages/details.php?id=PIA13410";
			points.push(poi);
			...
			poi.photoCredit = "Model Image Credit: NSSDC Photo Gallery";
